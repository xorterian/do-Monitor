...
You need to install the app Tailscale onto your phone. You also need to set it up from the command-line. Follow the instructions of the official website to see both the computer and the phone.
...
You will find your records in the directory "calls". Despite these being mp4 files, these are just sound files. You can convert them to mp3. Notice, these have two channels: one is yours, the other one is the dialed partners. You can filter one of them out, or unify them into one channel.
...
I can suggest the app MacroDroid which cannot record the calls and is not free but has a much richer toolset related to this topic.
